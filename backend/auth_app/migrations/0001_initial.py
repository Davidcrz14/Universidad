    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('director_global', 'Director Global'), ('director_instituto', 'Director de Instituto'), ('jefe_carrera', 'Jefe de Carrera'), ('professor', 'Profesor'), ('student', 'Estudiante')], max_length=20)),
